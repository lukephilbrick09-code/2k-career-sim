...
-- Migration: adds the manual XP allocation bank
alter table careers add column if not exists banked_xp numeric not null default 0;

-- Migration: adds the manual badge XP bank
alter table careers add column if not exists badge_xp numeric not null default 0;
